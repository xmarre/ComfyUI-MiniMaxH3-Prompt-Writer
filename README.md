...
- Native [Image Conveyor](https://github.com/xmarre/ComfyUI-Image-Conveyor) compatibility resolves its effective runtime outputs instead of trusting saved wires: disabled or empty persistent Reference Shelf slots stay out of the Continuum Picture inventory, Main/Last Frame switches are honored, and Queue execution groups follow **Images per execution**.
