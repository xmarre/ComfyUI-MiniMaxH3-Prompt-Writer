...
function continuumGraph({ samplerCount = 1, connected = true, referenceInputs = [] } = {}) {
  const links = {};
  const nodes = [];
...
test("Continuum temporal mode validation follows V3.4 First/Last wiring while allowing reference augmentation", () => {
...
test("Continuum generation and refinement require a real V3.4 sampler topology", () => {
  assert.match(
    mainSource,
